          ...
          <div className="container">
            ...
            <div className="wrapper-account">
              <ul className="list-option-account">
                ...
                <li
                  onClick={() => navigate("/my-account/download")}
                  className="option-item"
                >
                ...
                <li
                  onClick={() => navigate("/my-account/payment")}
                  className="option-item"
                >
                  Payment methods<i className="fa-solid fa-credit-card"></i>
                </li>
                <li
                  onClick={() => navigate("/my-account/account-detail")}
                  className="option-item"
                >
                  Account details<i className="fa-solid fa-user"></i>
                </li>
                <li onClick={handleLogout} className="option-item">
